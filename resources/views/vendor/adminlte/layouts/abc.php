...
<body>
  <div class="top_nav text-right">
    <div class="container">
      ...
      <a href="mailto:correo@abcsimple.com" class="icon"><img src="/assets_f/src/img/icon_email.png" alt="Enviar mensaje"></a>
        <a href="#a" class="login" data-toggle="modal" data-target="#myModal">Log In</a>
  ...
  <nav class="navbar navbar-default">
    <div class="container">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#"><img src="/assets_f/src/img/logo.png" style="height: 100%;"></a>
      </div>
  ...
  <section class="banner_home text-center" style="background-image: url(/assets_f/src/img/banner_home.jpg);">
    <div class="container">
      <h1>Curso fácil y Divertido</h1>
      <h2>Para pronunciar bien y comprender el inglés sin gramática.</h2>
      <div class="box_register">
        <h4>Comience a aprender ingles</h4>
        <h3 style="margin: 0;">
           AHORA
        </h3>
        <br>
        <div class="row">
          <div class="col-xs-6">
            <div class="form-group">
              ...
              <h4>Nombre <span class="text-danger">*</span></h4>
            </div>
          </div>
          <div class="col-xs-6">
            <div class="form-group">
              <input type="text" name="apellido" required class="form-control">
              <h4>Apellido <span class="text-danger">*</span></h4>
            </div>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <h4>Teléfono <span class="text-danger">*</span></h4>
        </div>
        <div class="form-group">
          ...
          <h4>País <span class="text-danger">*</span></h4>
        </div>
        <div class="form-group text-center">
          <button class="btn btn-primary btn_submit" type="submit">Empezar</button>
        </div>
      </div>
      <div class="redes_banner">
  ...
  <section class="video">
    <div class="container">
      <div class="col-sm-8">
        <div class="box">
          <iframe width="560" height="315" src="https://www.youtube.com/embed/1AvJKo3eKpo" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </div>
      </div>
      <div class="col-sm-4">
        <div class="text">
          <p>
            Haz que tus viajes y tiempo libre sean mas productivos con la aplicacion movil de ABC SIMPLE.
          </p>
          <br>
          <p>
            Descargala y ve por que apple y google nos otorgaron sus premios mas altos.
          </p>
        </div>
      </div>
    </div>
  ...
  <section class="testimonios text-center">
    <div class="container">
      <h2>Nuestras Historias de Exito</h2>
      <div class="testimonios_slick">
        <div class="testimonio">
          <div class="item">
            <img src="/assets_f/src/img/icon_linea.png" class="icon_linea">
            <img src="/assets_f/src/img/icon_comillas.png" class="icon_comillas">
            <h5>Victoria Perez <img src="/assets_f/src/img/bandera_colombia.png" alt="" class="icon_bandera"></h5>
            <p class="text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ex quod, consectetur </p>
            <p class="fecha">4 de Enero de 2018</p>
            <img src="/assets_f/src/img/icon_estrellas.png" class="icon_estrellas">
          </div>
        </div>
        <div class="testimonio">
          <div class="item">
  ...
  <section class="banner_bottom">
    <img src="/assets_f/src/img/banner_bottom.jpg">
  </section>
  <footer>
    <div class="container">
  ...
  <div class="modal fade" id="inscribete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-body">
          <div class="row">
            <div class="col-md-6 hidden-sm hidden-xs">
              <img src="/assets_f/src/img/img_modal_male.png" class="img_left male">
              <img src="/assets_f/src/img/img_modal_female.png" class="img_left female" style="display: none">
            </div>

            <div class="col-md-6 col-xs-12 text-center">
              <div class="box">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <img src="/assets_f/src/img/logo.png" class="logo">
                <h2>INSCRÍBETE</h2>
                <h4>Te regalamos el primer nivel</h4>
                <form method="POST" action="{{ route('cliente.register.post') }}">
                  ...
                  <div class="form-group text-center">
                    <div class="checkbox">
                      <label><input type="checkbox" value="">ENVÍENME LECCIONES DIARIAS GRATUITAS Y PROMOCIONES POR EMAIL</label>
                    </div>
                  </div>
                 </div>
                </form>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header text-center">
          ...
          <img src="/assets_f/src/img/logo.png" style="width: 130px;">
          <h2 style="color: #d21e62;"><span> BIENVENIDO</span></h2>
        </div>
        <div class="modal-body text-center">
          <form role="form" method="POST" action="{{ route('login') }}">
            {{ csrf_field() }}
            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
              <input type="text" class="form-control" name="email" id="usrname" placeholder="Correo">
                @if ($errors->has('email'))
            ...
            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
              <input type="password" class="form-control" name="password" id="psw" placeholder="Contraseña">
            ...
            <button type="submit" class="btn btn-default btn-sm" style="background: #268c9b; color: white; font-family: Eras Demi;"><span class="glyphicon glyphicon-off"></span> Login</button>
            <button type="submit" class="btn btn-default btn-danger btn-sm" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span>Cancel</button>
          </form>
        </div>
        <div class="modal-footer text-center" style="font-family: Eras Demi;">
          <p >¿No es un miembro? <a href="#">Regístrate</a></p>
