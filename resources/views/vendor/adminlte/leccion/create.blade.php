...
@section('main-content')
      ...
      <section class="content-header">
        ...
        @if($id_nivel == 0)
           ...
           <li><a>
        <form id="form_paquete" action="{{route('leccion.index')}}" method="GET">
                                        
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                                    
          <button type="submit" class="btn btn-primary btn-xs" data-toggle="tooltip" title="Regresar a Lecciones"><i class="glyphicon glyphicon-chevron-left"></i></button>                                                                            
        </form>
      </a>
    </li>
      </ol>
          ...
          <div id="div2" class="col-xs-12"> 
            <div id="div3" class="box box-primary"> 
                    <div id="div4" class="box-header"> 
                        <h3 class="box-title">Nueva Lección</h3>   
                    </div>  <!--div id="div4"-->  
                    ...
                    <div id="box-body_1" class="box-body">  
                        ...
                        <form method="post" action="{{ url('leccion')}}">           
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
...
<div class="box-body">
          @if($id_nivel==0)  
                 <div class="form-group">
                    <label>Nivel</label>
                    <select class="form-control select2" name="lista_id_nivel" style="width: 100%;">
                      @foreach($data as $row)
          ...
          @endif
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" name="nombre_leccion" class="form-control mayuscula" placeholder="Ingrese el Nombre" value="{{$_nomb}}" required>
                                </div>      
                                <div class="form-group">
                                <label for="exampleInputEmail">Descripción</label>
                                  <input type="text" name="descri_leccion" class="form-control mayuscula" placeholder="Ingrese la Descripción" value="{{$_descrip}}" required>
                                </div>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                   <label>Estado</label>
                   <select class="form-control select2" name="activo_leccion" style="width: 100%;">
