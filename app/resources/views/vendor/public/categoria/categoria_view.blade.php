    ...
    <section class="fondo-tienda-abc">
       ...
       @foreach($paquetes as $row)
          <div class="row c-tienda">
            ...
            <div class="col-12 col-md-5">
              <h2 style="color:#d21e62;font-weight: bold;">{{ $row-> nombre}}</h2>
              <!-- Aqui van la Descripcion del Producto -->
                <p style="text-align: justify;"> {{ $row-> descripcion}} Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa non ut ab iure consectetur explicabo sed necessitatibus nulla, quibusdam adipisci quisquam dolore vel magni ex debitis repudiandae dolorem facilis. Aut?</p>
      ...
      <section id="tienda-promociones " >
         @foreach($promociones as $row)
            <div class="row c-tienda">
              ...
              <div class="col-12 col-md-5">
                <h2 style="color:#d21e62;font-weight: bold;">Curso Fácil y Divertido {{ $row-> codigo}}</h2>
                <h3 style="color: #464646;font-weight: bold;">PRIMER NIVEL GRATIS {{ $row-> nombre}}</h3>
                <!-- Aqui van la Descripcion del Producto -->
                <p style="text-align: justify;"> {{ $row-> descripcion}} Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa non ut ab iure consectetur explicabo sed necessitatibus nulla, quibusdam adipisci quisquam dolore vel magni ex debitis repudiandae dolorem facilis. Aut?</p>
                <!-- Aqui van las Estrellas de Valoracion -->
      ...
      @foreach($cursos as $row)
            <div class="row c-tienda">
              ...
              <div class="col-12 col-md-5">
                <h2 style="color:#d21e62;font-weight: bold;">Curso Fácil y Divertido {{ $row-> codigo}}</h2>
                <h3 style="color: #464646;font-weight: bold;">{{ $row-> nombre}}</h3>
                <!-- Aqui van la Descripcion del Producto -->
