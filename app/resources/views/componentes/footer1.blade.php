                ...
                <form role="form" class="form" name="login" id="login" action="{{ route('cliente.login') }}" method="POST">
                  ...
                  <div class="modal-footer">
                    <div class="">
                      ...
                      <a type="button" id="submit" name="submit" class="btn btn-default " style="background: #268c9b; color: white; font-family: Eras Demi;"><span class="glyphicon glyphicon-off"></span> INGRESAR</a>
                  </div>
                </form>
              </div>
            </div>
