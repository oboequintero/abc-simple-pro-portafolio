                                                    ...
                                                    <table id="example1" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody >
                                                           ...
                                                           @php ($rowcount = 0)
                                                            ...
                                                            @endif
                                                            <div id="rowcount" data-row="{{$rowcount}}" style="display:none">
                                                            </div>
                            ...
                            if(datos['_ok'] === 0)
                            {
                                ...
                                var rowcount = 0;
                                    ...
                                    for (item in datos._msg)
                                    {
                                        ...
                                        //////
                                       // $("#rowcount").data("row", 888);


                                    }//fin for (item in datos._msg)
                                    
                                    //Asociar al campo data del div el total de filas de la tabla
                                    $("#rowcount").data("row", rowcount);
                        ...
                        $(function() {
                               ...
                               // $("[data-toggle='tooltip']").tooltip({delay: 500});
                                ...
                                $('#example1').on('click', "tr", function(event){                                   
                                     ...
                                     } //Fin if($("#rowcount").data('row') == 0)                                    
                                    
                                }); //Fin $('#example1').on('click', "tr", function(event){                                   
